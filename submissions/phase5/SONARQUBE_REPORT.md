...
- **Authentication:** Admin Global Analysis Token, supplied to the scanner through
  the `SONAR_TOKEN` environment variable. The token value is deliberately not
  reproduced here -- it was previously pasted into this line in full, which
  published a live credential to the repository.
